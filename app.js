...
var addButton = document.querySelector(".main__button-add"); //first button
...
var editTask = function () {
  ...
  if (containsClass) {
    ...
    label.classList.remove("task__input");
  } else {
    editInput.value = label.innerText;
    label.classList.add("task__input");
    editBtn.innerText = "Save";
    editInput.classList.add("edit-task");
    editInput.classList.remove("task__input");
  }
...
var taskCompleted = function () {
  ...
  var listItem = this.parentNode;
  var label = listItem.querySelector("label");
  label.classList.remove("task-label");
  label.classList.add("task_done");
...
var taskIncomplete = function () {
  ...
  var listItem = this.parentNode;
  var label = listItem.querySelector("label");
  label.classList.remove("task_done");
